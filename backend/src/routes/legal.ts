...
const PRIVACY_SECTIONS = [
  ...
  { h: '4. AI Legal Assistant & Third Parties', p: "When you use the AI Legal Assistant or AI Rate Advisor, your messages are processed by xAI's Grok API. xAI's privacy policy applies to this processing. We do not share your personal identity with xAI — only the message content is transmitted." },
