...
<div class="meta">Generated ${new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })} · Road Ready Network · Estimated quarterly payment due ${qInfo.due}</div>
