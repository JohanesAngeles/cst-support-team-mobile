...
<div class="header">
  ...
  <div class="meta">Generated by Road Ready Network · ${new Date().toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</div>
</div>
<pre>${letter.replace(/</g, '&lt;').replace(/>/g, '&gt;')}</pre>
<div class="footer">This document was generated as a template. Review and customize before submitting. Road Ready Network — Commercial Support Technologies</div>
</body></html>`;
