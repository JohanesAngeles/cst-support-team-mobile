...
export default function RateBenchmarkScreen() {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    typeChip: {
      ...
      backgroundColor: Colors.surfaceLight ?? '#1E3A5C', borderWidth: 1, borderColor: Colors.border,
    },
    ...
    rateBox: { flex: 1, alignItems: 'center', backgroundColor: Colors.surfaceLight ?? '#1E3A5C', borderRadius: 10, padding: 12 },
