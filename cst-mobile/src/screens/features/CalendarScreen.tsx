...
const urgencyColor = (days: number) => days < 0 ? '#E74C3C' : days <= 7 ? '#E67E22' : days <= 30 ? '#F39C12' : Colors.success;
          ...
          <View style={styles.modalBox}>
            ...
            <View style={styles.typeGrid}>
              {DEADLINE_TYPES.map((t) => (
                ...
                >
                  <Text style={[styles.typeChipText, newType === t && { color: Colors.white }]}>{t}</Text>
                </TouchableOpacity>
              ))}
            </View>
