...
export default function IFTATrackerScreen() {
  ...
  const exportPDF = async () => {
    ...
    const html = `
      ...
      <div class="subtitle">Q${quarter} ${year} &nbsp;·&nbsp; Generated ${new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })} &nbsp;·&nbsp; Road Ready Network</div>
      <div class="summary">
      ...
      <div class="footer">
        ...
        <p style="margin-top:16px;color:#bbb;">Generated by Road Ready Network</p>
      </div>
      </body></html>`;
