...
const styles = StyleSheet.create({
  ...
  heroBody: { flex: 1 },
  heroState: { color: Colors.white, fontSize: 20, fontWeight: '800' },
  ...
  cardTitle: { color: Colors.white, fontSize: 15, fontWeight: '800', flex: 1 },
  ruleRow: {
  ...
  ruleValue: { color: Colors.white, fontSize: 13, fontWeight: '600', textAlign: 'right', flex: 1 },
