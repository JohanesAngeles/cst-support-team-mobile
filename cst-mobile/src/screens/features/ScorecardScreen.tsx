...
function grade(sc: Scorecard): { letter: string; color: string; label: string } {
  if (!sc.totalMiles && !sc.grossRevenue) return { letter: '—', color: Colors.textMuted, label: 'No data' };
  ...
  return { letter: 'D', color: Colors.danger, label: 'Low-revenue week' };
}
              ...
              <>
                ...
                <View style={s.expCard}>
                  ...
                  <View style={[s.expRow, { borderTopWidth: 1, borderColor: Colors.border, paddingTop: 8, marginTop: 4 }]}>
                    <Text style={[s.expLabel, { color: Colors.white, fontWeight: '700' }]}>Total Costs</Text>
...
const s = StyleSheet.create({
  ...
  weekLabel: { color: Colors.white, fontSize: 14, fontWeight: '800' },
  ...
  sectionTitle: { color: Colors.white, fontSize: 15, fontWeight: '800', marginBottom: 12, marginTop: 4 },
  ...
  fuelVal: { color: Colors.white, fontSize: 22, fontWeight: '900' },
  ...
  tipText: { color: Colors.white, fontSize: 12, lineHeight: 18, flex: 1 },
