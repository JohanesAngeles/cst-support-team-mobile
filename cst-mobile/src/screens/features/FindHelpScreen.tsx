...
const bc = StyleSheet.create({
  card:         { flexDirection: 'row', alignItems: 'center', backgroundColor: '#121212', borderRadius: 14, padding: 14, borderWidth: 1, borderColor: '#2A2A2E', marginBottom: 8, gap: 12 },
  ...
  flag:         { backgroundColor: '#1E1E1E', borderRadius: 4, paddingHorizontal: 6, paddingVertical: 2 },
...
const dm = StyleSheet.create({
  ...
  sheet:      { backgroundColor: '#121212', borderTopLeftRadius: 28, borderTopRightRadius: 28, padding: 24, paddingBottom: 44, position: 'absolute', bottom: 0, left: 0, right: 0, maxHeight: '80%' },
  handle:     { width: 40, height: 4, borderRadius: 2, backgroundColor: '#2A2A2E', alignSelf: 'center', marginBottom: 20 },
  ...
  closeBtn:   { width: 32, height: 32, borderRadius: 16, backgroundColor: '#1E1E1E', justifyContent: 'center', alignItems: 'center' },
  ...
  details:    { gap: 10, marginBottom: 20, backgroundColor: '#121212', borderRadius: 16, padding: 14, borderWidth: 1, borderColor: '#2A2A2E' },
  ...
  dirBtn:     { flex: 2, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', height: 52, borderRadius: 14, backgroundColor: '#1E1E1E', borderWidth: 1, borderColor: '#2A2A2E', gap: 8 },
  dirBtnText: { fontSize: 15, fontWeight: '700', color: '#C8D2DC' },
  webBtn:     { width: 52, height: 52, borderRadius: 14, backgroundColor: '#1E1E1E', borderWidth: 1, borderColor: '#2A2A2E', justifyContent: 'center', alignItems: 'center' },
  couponBox:    { marginTop: 16, backgroundColor: '#121212', borderRadius: 14, padding: 14, borderWidth: 1.5, borderColor: '#F5C842', gap: 6 },
  ...
  rateToggle:     { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, marginTop: 16, paddingVertical: 12, borderRadius: 12, borderWidth: 1, borderColor: '#2A2A2E', backgroundColor: '#1E1E1E' },
  rateToggleText: { fontSize: 14, fontWeight: '700', color: '#C8D2DC' },
  rateBox:        { marginTop: 16, backgroundColor: '#121212', borderRadius: 16, padding: 16, borderWidth: 1, borderColor: '#2A2A2E', alignItems: 'center', gap: 12 },
  rateTitle:      { fontSize: 15, fontWeight: '800', color: '#FFFFFF' },
  starPicker:     { flexDirection: 'row', gap: 8 },
  commentInput:   { width: '100%', backgroundColor: '#1E1E1E', borderRadius: 10, borderWidth: 1, borderColor: '#2A2A2E', padding: 12, fontSize: 14, color: '#FFFFFF', minHeight: 72, textAlignVertical: 'top' },
...
export default function FindHelpScreen() {
  ...
  const styles = useMemo(() => StyleSheet.create({
    ...
    featuredCard:     { width: 200, backgroundColor: '#121212', borderRadius: 16, padding: 14, marginRight: 12, borderWidth: 1.5, borderColor: '#F5C842', gap: 6 },
